<%@page import="de.hwg_lu.bwi420Beans.PortalBean"%>
...
<jsp:useBean id="myPB" class="de.hwg_lu.bwi420Beans.PortalBean" scope="session" />
...
//	}
%>
<jsp:getProperty name="myLogin" property="loginCheckRedirectHtml" />
<ul>
<jsp:getProperty name="myPB" property="webApplicationsAsHtmlLink" />
<!-- 
	...
	<li><a href="./PortalAppl.jsp?applicationPath=ShowAllAccountsView.jsp">Accounts verwalten</a></li>
 -->
</ul>
<br>
